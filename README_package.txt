...
1. Start a search of recipes by specifying ingredients that you currently have
    a. Each ingredient must be recognized by the application. Ingredients not
       recognized are currently not supported
...
2. Pull the docker image for the app
    ...
    c. sudo docker pull wiki1677/dva-recipe-app

3. Run the docker image
    a. sudo docker run -d --name recipe-app -p 80:80 wiki1677/dva-recipe-app
...
4. Open in browser
    ...
    b. The application may take a little time to load, as it fetches initial
       data
...
2. mkdir backend/modeling/outputs
2. cd supplementary; unzip 19321120.zip; mv 19321120 ../backend/modeling/outputs/ ; cd ..
2. sudo docker build -t wiki1677/dva-recipe-app:<TAG> -f environment/Dockerfile .
...
1. Install Python 3.7, and requirements
    ...
    b. Create a virtual environment
        i. cd <app-extracted-dir>/CODE
        ii. python3.7 -m venv .venv
        iii. . .venv/bin/activate
...
3. Unzip model files. "app-extracted-dir" is the directory this package was
   extracted to:
    a. cd <app-extracted-dir>/CODE/
    b. mkdir backend/modeling/outputs
    c. cd supplementary; unzip 19321120.zip; mv 19321120 ../backend/modeling/outputs/ ; cd ..

4. Run flask:
    a. cd <app-extracted-dir>/CODE
    b. Create .env file using environment variables defined in
       <app-extracted-dir>/CODE/environment/Dockerfile
    c. Edit <app-extracted-dir>/CODE/backend/routes.py and fix the path in
       model_path variable
    c. flask run -p 8080
...
<app-extracted-dir>/CODE/data-prep/instructions.txt to download the dataset,
and set up the database. This directory also includes the open-refine project
...
3. PYTHONPATH=.. python3.7 train_model.py